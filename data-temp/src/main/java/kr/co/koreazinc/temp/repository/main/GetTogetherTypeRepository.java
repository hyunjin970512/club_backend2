...
public class GetTogetherTypeRepository extends AbstractJpaRepository<CoCommonCode, CoCommonCodeId> {

    private static final String MAIN_CODE_CLUB_TYPE = "TOGETHER_TYPE";

    public GetTogetherTypeRepository(List<EntityManager> entityManagers) {
