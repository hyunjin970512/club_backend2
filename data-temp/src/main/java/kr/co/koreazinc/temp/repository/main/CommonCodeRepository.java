...
public class CommonCodeRepository extends AbstractJpaRepository<CoCommonCode, CoCommonCodeId> {

    private static final String MAIN_CODE_CLUB_TYPE = "CLUB_TYPE";

    public CommonCodeRepository(List<EntityManager> entityManagers) {
